...
export const ObserverModeToggle = () => {
  ...
  return (
    <motion.button
      className="fixed top-6 left-[calc(50%+6rem)] z-50 flex items-center gap-2 px-3 py-2 rounded-lg glass-card text-xs font-mono transition-colors whitespace-nowrap"
