...
const MiniGame = () => {
  ...
  const springY = useSpring(hudY, { damping: 20, stiffness: 200 });
  ...
  return (
    <section id="mini-game" className="py-24 relative overflow-hidden">
            ...
            <AnimatePresence>
              {gameState === "playing" &&
                safeZones.map((zone, index) => (
                  <motion.div
                    key={index}
                    className="absolute rounded-lg border-2 border-dashed border-neon-green/40"
              ...
              {gameState === "idle" && (
                ...
                >
                  <MagnetButton>
                    <button
                      onClick={startGame}
                      className="px-8 py-4 rounded-xl font-semibold text-lg btn-cyber-green"
                    >
                      Start Game
                    </button>
                  </MagnetButton>
              ...
              {gameState === "lost" && (
                ...
                >
                  ...
                  <motion.h3
                    ...
                    initial={{ opacity: 1 }}
                    animate={{ opacity: [1, 0], y: [0, 50], rotateX: [0, 45] }}
